"""
Django settings for dummydatabases project.
...
INSTALLED_APPS = [
    'databaseGen.apps.DatabasegenConfig',
...
ROOT_URLCONF = 'dummydatabases.urls'
...
WSGI_APPLICATION = 'dummydatabases.wsgi.application'
